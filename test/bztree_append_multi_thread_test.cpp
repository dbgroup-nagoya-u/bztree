...
using TestTargets = ::testing::Types<  //
    ...
    IndexInfo<BzTree, UInt4, Int4>,    // small keys/payloads
    IndexInfo<BzTree, Var, Int8>,      // variable-length keys
    IndexInfo<BzTree, Ptr, Int8>,      // pointer keys/payloads
    IndexInfo<BzTree, Original, Int8>  // original class keys/payloads
    >;
