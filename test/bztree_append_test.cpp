...
using TestTargets = ::testing::Types<  //
    ...
    IndexInfo<BzTree, UInt4, Int8>,    // small keys
    IndexInfo<BzTree, UInt4, UInt4>,   // small keys/payloads
    IndexInfo<BzTree, Var, Int8>,      // variable-length keys
    IndexInfo<BzTree, Var, UInt4>,     // variable-length keys and small payloads
    IndexInfo<BzTree, Ptr, Int8>,      // pointer keys
    IndexInfo<BzTree, Original, Int8>  // original class keys
    >;
