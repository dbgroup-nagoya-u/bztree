...
class InternalNode : public BaseNode
{
 private:
      ...
      const size_t end_index)
  {
    ...
    SetStatusWord(Status::AddRecordInfo(0, sorted_count, offset, 0));
 ...
 public:
      ...
      const size_t split_index)
  {
    ...
    SetStatusWord(Status::AddRecordInfo(0, record_count, offset, 0));
      ...
      BaseNode *right_child)
  {
    ...
    new_root->SetStatusWord(Status::AddRecordInfo(0, 2, offset, 0));
      ...
      Compare comp)
  {
    ...
    new_parent->SetStatusWord(Status::AddRecordInfo(0, record_count, offset, 0));
